      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden w-full h-full rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 flex flex-col">
          ...
          <div className="h-28 bg-gradient-to-r from-primary to-primary/80 relative flex flex-col items-center justify-center pt-2">
            ...
            <h2 className="text-white font-heading font-black tracking-wider text-xl uppercase">Public News 1</h2>
            <p className="text-primary-foreground/80 text-[10px] font-semibold tracking-[0.2em] uppercase mt-1">Press Identity Card</p>
          ...
          <div className="px-6 pb-6 flex-1 flex flex-col text-center">
            ...
            <p className="text-primary font-bold text-sm tracking-widest uppercase mt-1">Senior Reporter</p>
            ...
            <div className="mt-4 grid grid-cols-2 gap-x-2 gap-y-3 text-left bg-slate-50 dark:bg-slate-900/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800/50">
              <div>
                <p className="text-[9px] text-slate-500 uppercase font-bold tracking-wider">ID Number</p>
                <p className="font-mono text-xs font-bold text-slate-800 dark:text-slate-200">PN1-MH-0842</p>
              </div>
              <div>
                <p className="text-[9px] text-slate-500 uppercase font-bold tracking-wider">Blood Group</p>
                <p className="text-xs font-bold text-red-600 dark:text-red-500">O+ Positive</p>
              </div>
              <div>
                <p className="text-[9px] text-slate-500 uppercase font-bold tracking-wider">State</p>
                <p className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate">Maharashtra</p>
              </div>
              <div>
                <p className="text-[9px] text-slate-500 uppercase font-bold tracking-wider">District</p>
            ...
            <div className="mt-auto flex items-end justify-between pt-4">
              <div className="text-left">
                <p className="text-[9px] text-slate-500 uppercase font-bold tracking-wider">Valid Till</p>
        ...
        >
          ...
          <div className="p-6 flex-1 flex flex-col text-sm">
            <h4 className="font-bold text-slate-900 dark:text-white mb-2 uppercase text-xs tracking-wider">Terms & Conditions</h4>
            <ul className="text-[10px] text-slate-600 dark:text-slate-400 space-y-1.5 list-disc pl-3 text-justify">
              <li>This card is the property of PUBLIC NEWS 1.</li>
              <li>It must be surrendered upon termination of service or upon demand by the issuing authority.</li>
              <li>Loss of this card must be reported immediately to the head office.</li>
              <li>This card authorizes the bearer to gather news and information on behalf of the organization.</li>
            </ul>

            <div className="mt-6 bg-white dark:bg-slate-950 p-3 rounded border border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-2 mb-1">
                <Phone className="w-3 h-3 text-primary" />
                <p className="text-[10px] uppercase font-bold tracking-wider text-slate-500">Emergency Contact</p>
              </div>
            ...
            <div className="mt-auto pt-4 text-center">
              <div className="w-32 h-8 border-b-2 border-slate-300 dark:border-slate-700 mx-auto mb-1 flex items-end justify-center">
                <span className="font-signature text-xl text-slate-800 dark:text-slate-300 opacity-80">Authorised</span>
              </div>
              <p className="text-[9px] uppercase font-bold text-slate-500 tracking-widest">Issuing Authority</p>
            </div>

            <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-800 text-center">
              <p className="text-[8px] text-slate-400">Verify at: verify.publicnews1.in/PN1-MH-0842</p>
              {/* Fake Barcode */}
