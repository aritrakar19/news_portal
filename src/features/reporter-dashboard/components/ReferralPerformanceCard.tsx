    ...
    <Card className="border-border shadow-sm h-full bg-gradient-to-br from-primary/5 via-transparent to-transparent">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground mb-6">
          Invite other journalists to the network. Earn ₹500 for every reporter who gets verified and publishes their first story.
        </p>

        <div className="bg-slate-100 dark:bg-slate-900 rounded-lg p-4 mb-6 flex items-center justify-between border border-border">
          <div>
            <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold mb-1">Your Invite Code</p>
            <p className="text-xl font-mono font-bold text-foreground tracking-widest">PN1-ARITRA</p>
          </div>
          <Button variant="outline" size="icon" className="shrink-0" title="Copy Code">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white dark:bg-card border border-border rounded-lg p-3 text-center">
            ...
            <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-wide">Referral Count</p>
          </div>
          <div className="bg-white dark:bg-card border border-border rounded-lg p-3 text-center">
            ...
            <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-wide">Active Referrals</p>
          </div>
          <div className="bg-white dark:bg-card border border-border rounded-lg p-3 text-center">
            ...
            <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-wide">Commission Earned</p>
          </div>
        </div>
      </CardContent>
    </Card>
