  ...
  return (
    <div className="bg-slate-900 text-white border border-slate-800 shadow-lg rounded-xl overflow-hidden relative">
      ...
      <div className="p-6 border-b border-slate-800 bg-slate-950/50 relative z-10 flex items-center gap-3">
        ...
        <h3 className="font-heading font-bold text-xl">Bonus Rewards Program</h3>
      </div>
      ...
      <div className="p-6 space-y-8 relative z-10">
        ...
        <div>
          <div className="flex justify-between items-end mb-2">
            <div>
              <p className="text-sm font-semibold text-slate-300">Next Milestone: <span className="text-white">Network Builder</span></p>
              <p className="text-xs text-slate-400 mt-1">Reach 20 active reporters to unlock a ₹5,000 cash bonus.</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 flex flex-col items-center text-center">
            ...
            <h4 className="font-bold text-sm text-slate-200">Join Bonus</h4>
            <p className="text-xs text-slate-400 mt-1 mb-2">Earned when a referee registers with your code.</p>
          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 flex flex-col items-center text-center">
            ...
            <h4 className="font-bold text-sm text-slate-200">Active Bonus</h4>
            <p className="text-xs text-slate-400 mt-1 mb-2">Earned when your referee publishes their first news.</p>
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <h4 className="font-bold text-sm text-amber-200">Revenue Share</h4>
            <p className="text-xs text-amber-200/60 mt-1 mb-2">Earn a percentage of your active reporters' revenue.</p>
            <span className="mt-auto font-black text-xl text-amber-400">5% Lifetime</span>
          </div>
        </div>
      </div>
    </div>
