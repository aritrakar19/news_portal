  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-heading font-extrabold text-slate-900 dark:text-white">Referrals & Network</h1>
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Grow your network and earn passive income for every reporter you invite to PUBLIC NEWS 1.
          </p>
        </div>
      </motion.div>
