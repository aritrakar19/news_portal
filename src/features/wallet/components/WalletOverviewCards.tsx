    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white border border-slate-700 shadow-lg rounded-xl p-6 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="flex justify-between items-start mb-4 relative z-10">
          <div>
            <p className="text-sm font-medium text-slate-300 uppercase tracking-wider">{t("wallet.overview.available", "Available Balance")}</p>
        ...
        <p className="text-xs text-slate-400 relative z-10">{t("wallet.overview.ready", "Ready for withdrawal")}</p>
      </div>
      ...
      <div className="bg-white dark:bg-card border border-border shadow-sm rounded-xl p-6 flex flex-col justify-between">
        <div className="flex justify-between items-start mb-4">
          <div>
            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t("wallet.overview.pending", "Pending Clearance")}</p>
        ...
        <p className="text-xs text-muted-foreground">{t("wallet.overview.willClear", "Will clear in 2-3 business days")}</p>
      </div>
      ...
      <div className="bg-white dark:bg-card border border-border shadow-sm rounded-xl p-6 flex flex-col justify-between">
        <div className="flex justify-between items-start mb-4">
          <div>
            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t("wallet.overview.withdrawn", "Total Withdrawn")}</p>
        ...
        <p className="text-xs text-muted-foreground">{t("wallet.overview.lifetimeWithdrawn", "Lifetime successful withdrawals")}</p>
      </div>
      ...
      <div className="bg-white dark:bg-card border border-border shadow-sm rounded-xl p-6 flex flex-col justify-between">
        <div className="flex justify-between items-start mb-4">
          <div>
            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t("wallet.overview.lifetimeEarnings", "Lifetime Earnings")}</p>
        ...
        <p className="text-xs text-muted-foreground">{t("wallet.overview.totalRevenue", "Total revenue generated")}</p>
      </div>
    </div>
  )
}
